...
const OrderUploadMediaSheet: FC<Props> = ({ order, children }) => {
  ...
  const handleUploadMedia = () => {
    post(route('transaction.upload-media', order.id), {
      preserveScroll: true,
      onSuccess: () => {
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>Upload media to order</SheetDescription>
        </SheetHeader>
...
export default OrderUploadMediaSheet;